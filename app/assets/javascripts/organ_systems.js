...
// female 3d model
var fhuman = new HumanAPI("fembedded-human");

$("#fnasopharynx").on("click", function(e) {
  e.preventDefault();
  fhuman.send("camera.set", { objectId: "human_05_male_respiratory_system-pharynx_ID", animate: true });
});

$("#frespiratory").on("click", function(e) {
  e.preventDefault();
  fhuman.send("camera.set", { objectId: "human_05_male_respiratory_system-respiratory_system_ID", animate: true });
});

$("#fstomach").on("click", function(e) {
  e.preventDefault();
  fhuman.send("camera.set", { objectId: "human_05_male_digestive_system-stomach_ID", animate: true });
});

$("#fsmallintestine").on("click", function(e) {
  e.preventDefault();
  fhuman.send("camera.set", { objectId: "human_05_male_digestive_system-small_intestines_ID", animate: true });
});

$("#flargeintestine").on("click", function(e) {
  e.preventDefault();
  fhuman.send("camera.set", { objectId: "human_05_male_digestive_system-colon_ID", animate: true });
});
